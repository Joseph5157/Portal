    ...
    <div class="min-h-screen bg-[#08080a] text-slate-300 font-['Outfit'] pb-20">
        ...
        <nav
            ...
            <div class="flex items-center gap-8">
                <div class="flex gap-4">
                    <span
                        class="flex items-center gap-1.5 text-[10px] font-bold text-slate-600 uppercase tracking-widest cursor-not-allowed">Users
                        <span
                            class="text-[7px] font-black text-red-500/40 bg-red-500/5 border border-red-500/10 px-1 py-0.5 rounded">Soon</span></span>
                    <span
                        class="flex items-center gap-1.5 text-[10px] font-bold text-slate-600 uppercase tracking-widest cursor-not-allowed">Clients
                        <span
                            class="text-[7px] font-black text-red-500/40 bg-red-500/5 border border-red-500/10 px-1 py-0.5 rounded">Soon</span></span>
                    <span
                        class="flex items-center gap-1.5 text-[10px] font-bold text-slate-600 uppercase tracking-widest cursor-not-allowed">System
                        <span
                            class="text-[7px] font-black text-red-500/40 bg-red-500/5 border border-red-500/10 px-1 py-0.5 rounded">Soon</span></span>
                </div>
        ...
        <main class="max-w-7xl mx-auto px-10 py-12 space-y-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div
                    class="bg-gradient-to-b from-white/[0.03] to-transparent border border-white/5 p-8 rounded-[2.5rem] relative overflow-hidden group">
                    <p class="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">Pulse • Files Today
                    </p>
                    <div class="flex items-end justify-between">
                        <h2 class="text-5xl font-bold text-white tracking-tighter">{{ $stats['total_processed_today'] }}
                        </h2>
                        <div
                            class="w-10 h-10 bg-green-500/10 rounded-xl flex items-center justify-center text-green-500">
                ...
                <div
                    class="bg-gradient-to-b from-white/[0.03] to-transparent border border-white/5 p-8 rounded-[2.5rem] relative overflow-hidden group">
                    <p class="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">Pending • Pool Size
                    </p>
                    <div class="flex items-end justify-between">
                ...
                <div
                    class="bg-gradient-to-b from-white/[0.03] to-transparent border border-white/5 p-8 rounded-[2.5rem] relative overflow-hidden group">
                    <p class="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">Active • Workforce
                    </p>
                    <div class="flex items-end justify-between">
                ...
                <div
                    class="bg-gradient-to-b from-white/[0.03] to-transparent border border-white/5 p-8 rounded-[2.5rem] relative overflow-hidden group">
                    <p class="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">Growth • New Clients
                    </p>
                    <div class="flex items-end justify-between">
                        <h2 class="text-5xl font-bold text-white tracking-tighter">{{ $stats['new_clients_today'] }}
                        </h2>
                        <div
                            class="w-10 h-10 bg-purple-500/10 rounded-xl flex items-center justify-center text-purple-500">
                ...
                <div class="lg:col-span-8 space-y-8">
                    <div class="bg-[#0a0a0c] border border-white/5 rounded-[3rem] p-10">
                        <div class="flex justify-between items-center mb-10">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-10 h-10 bg-red-500/10 rounded-2xl flex items-center justify-center text-red-500">
                                    <i data-lucide="zap" class="w-5 h-5"></i>
                                </div>
                                <div>
                                    <h2 class="text-lg font-bold text-white">Vendor Performance</h2>
                                    <p class="text-[10px] text-slate-600 font-bold uppercase tracking-widest mt-0.5">Top
                                        contributors today</p>
                                </div>
                            </div>
                            <button
                                class="px-5 py-2 bg-white/5 hover:bg-white/10 text-slate-400 text-[10px] font-bold uppercase tracking-widest rounded-xl transition-all border border-white/5">Export
                                All</button>
                        </div>
                                    ...
                                    @foreach($vendorPerformance as $vendor)
                                        <tr class="group hover:bg-white/[0.01] transition-all">
                                            <td class="py-6 px-4">
                                                <div class="flex items-center gap-4">
                                                    <div
                                                        class="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center text-slate-500 group-hover:bg-red-500/10 group-hover:text-red-500 transition-all border border-white/5">
                                                        <i data-lucide="user" class="w-5 h-5"></i>
                                                    </div>
                                                    <div>
                                                        <h4 class="text-sm font-bold text-slate-300">{{ $vendor->name }}
                                                        </h4>
                                                        <p class="text-[9px] text-slate-600 font-mono">{{ $vendor->email }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="py-6 text-center">
                                                <span
                                                    class="px-3 py-1 bg-green-500/10 text-green-500 rounded-lg text-xs font-bold border border-green-500/10">
                                                    {{ $vendor->today_jobs }}
                                                </span>
                                            </td>
                                            ...
                                            <td class="py-6 text-right">
                                                <div class="flex justify-end items-center gap-2">
                                                    ...
                                                    <span
                                                        class="text-[10px] font-bold text-slate-600 tracking-tighter">PHASE_01</span>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="lg:col-span-4 space-y-8">
                    <div class="bg-[#0a0a0c] border border-white/5 rounded-[3rem] p-10 h-full">
                                    ...
                                    <div class="space-y-1">
                                        <div class="flex justify-between items-start">
                                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-tight">
                                                @if($order->status == 'delivered') Result Uploaded @else Processing Stream
                                                @endif
                                            </p>
                                            <span
                                                class="text-[8px] font-mono text-slate-700 uppercase tracking-tighter">{{ $order->created_at->diffForHumans() }}</span>
                                        </div>
                        ...
                        <div class="mt-12 pt-8 border-t border-white/5">
                            <button
                                class="w-full py-4 bg-red-600/10 hover:bg-red-600/20 text-red-500 text-[10px] font-bold uppercase tracking-[0.3em] rounded-2xl border border-red-600/20 transition-all">
                                View Security Logs
                            </button>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-xs text-slate-600 font-medium">Configure global upload limits, maintenance modes and
                        API keys.</p>
                </div>
            </div>
        </main>
        ...
        <footer class="p-12 text-center border-t border-white/5 bg-[#0a0a0c]">
            <p class="text-[9px] font-black text-slate-700 uppercase tracking-[0.6em]">System Architecture • Core Node •
                Active</p>
        </footer>
    </div>
