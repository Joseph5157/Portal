...
<body class="bg-[#0f1117] text-slate-300 antialiased">

    <div class="flex h-screen overflow-hidden">

        {{-- ===== SIDEBAR ===== --}}
        <aside class="w-[220px] flex-shrink-0 bg-[#13151c] border-r border-white/[0.06] flex flex-col h-full">
            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('dashboard') }}"
                    class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-400 {{ request()->routeIs('dashboard') ? 'active' : '' }}">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            {{-- Top Bar --}}
            <header
                class="flex items-center justify-between px-8 py-4 bg-[#0f1117] border-b border-white/[0.06] flex-shrink-0">
                <div>
                ...
                <div class="flex items-center gap-4">
                    {{-- Live Sync --}}
                    <div
                        class="hidden sm:flex items-center gap-1.5 bg-[#162a1f] border border-emerald-500/20 px-3 py-1.5 rounded-full">
                        <span
                    ...
                    <div class="group relative">
                        ...
                        <div
                            class="absolute right-0 top-full mt-2 w-48 bg-[#1c1e27] border border-white/10 rounded-2xl p-1.5 shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                            <a href="{{ route('profile.edit') }}"
            ...
            {{-- Scrollable content --}}
            <main class="flex-1 overflow-y-auto px-8 py-7 space-y-6">
                {{ $slot }}
            </main>
        </div>
    </div>
